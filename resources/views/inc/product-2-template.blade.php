<div class="card overflow-hidden product-content card-product">
    ...
    <div class="card-product-header d-block ">
        ...
        <a href="#!">
            <img
                src="https://images.migrosone.com/sanalmarket/product/31020036/31020036-8cf054.jpeg"
    ...
    <div id="discount-badge" class="discount-badge ng-star-inserted">
        <div><span id="discount-badge--percent"
                ...
                id="discount-badge--unit" class="discount-badge--unit">16</span>
        </div>
    ...
    <div class="card-product-body  px-1">
        <a id="product-name" class="mat-caption text-color-black product-name"
           href="#!"> Familia Plus Natural Havlu 16'lı
        </a>
        <div class="card-product-body-overlay mt-2">
            ...
            <span class="card-product-price">
                                                <div class="mat-caption text-dark discount-banner" style="">
                                                      <div class="mat-caption text-color-black">259,95 TL
                                                </div>
                                                   <span class="card-product-price-title">154,95TL</span>
                                                </div>
                                            </span>
            <span class="text-color-grey fs-11 fw-bold">(9,68 TL/Adet)</span>
